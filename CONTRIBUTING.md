# 🤝 Guide de contribution à Cryptographie

Merci de votre intérêt pour contribuer à ce dépôt dédié à la cryptographie appliquée à la cybersécurité ! Voici les étapes et bonnes pratiques à suivre :
...
2. **Créez une branche** dédiée à votre contribution :
   ...
   ```
3. **Ajoutez vos modifications** (cours, guides, exemples, corrections, etc.).
4. **Respectez la structure** des dossiers et la nomenclature des fichiers.
5. **Testez** vos scripts ou exemples avant de proposer une modification.
...
Merci pour votre contribution à la communauté Cryptographie !
